...
public interface BlogDao {
     ...
     * @return
     */
    Long getHomeBlogCountByTag(@Param("tagId") Integer tagId);
    /**
     * 查询主页博客
     *
     * @param start
     ...
     * @return
     */
    List<Blog> findHomeBlogByTag(@Param("start") Integer start, @Param("showCount") Integer showCount, @Param("tagId") Integer tagId);
    /**
     * 查询主页博客
     *
     * @param start
