    ...
    <div>
      <el-row>
        ...
        >
          ...
          <el-menu-item index="2" style="margin-left: 2%" route="/message"
            >留言板</el-menu-item
          >
          <el-menu-item index="3" style="margin-left: 2%" route="/announcement"
            >实验室简介</el-menu-item
          >
          ...
          >
            <el-form :model="form">
              ...
              <el-button @click="userRegister"
                >注册&nbsp;&nbsp;<i class="el-icon-check"></i
              ></el-button>
            </el-form>
          </el-dialog>
          ...
          >
            <template slot="title"
              >[&nbsp;&nbsp;{{ this.$store.state.name }}&nbsp;&nbsp;]</template
            >
          ...
          <el-menu-item route="/newBlog" index="5"
            >&nbsp;
            <i class="el-icon-edit"></i>
            添加会议记录
          </el-menu-item>
          <el-menu-item route="/myBlog" index="5"
            >&nbsp;
            <i class="el-icon-s-home"></i>
            我添加的记录
          </el-menu-item>
...
export default {
  ...
  methods: {
    ...
    userRegister() {
      ...
      console.log("registerMailCode:", this.form.registerMailCode);

      user
        .register(
          this.form.registerName,
          this.form.registerPwd,
          this.form.registerMail,
          this.form.registerMailCode,
          this.form.registerInviteCode
        )
        .then((res) => {
          this.$message({
            message: "注册成功",
