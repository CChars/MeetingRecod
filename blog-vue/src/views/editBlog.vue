...
export default {
  ...
  watch: {
    blogId() {
      ...
      blog.getBlogById(this.blogId, true).then((res) => {
        ...
        console.log("paperURL", res.data.paperURL);
        if (res.data.paperURL != null) {
          this.PaperFilesId.push(res.data.paperURL);
          this.PaperFilesList.push({
            name: res.data.paperURL,
            url: res.data.paperURL,
          });
        }
        console.log("pptURL", res.data.pptURL);
        if (res.data.pptURL != null) {
          this.PptFilesId.push(res.data.pptURL);
          this.PptFilesList.push({
            name: res.data.pptURL,
            url: res.data.pptURL,
          });
        }
      });
  ...
  methods: {
    editBlog() {
      ...
      console.log("PaperFilesList", this.PaperFilesId[0]);
      this.ruleForm.paperURL = this.PaperFilesId[0];
      this.ruleForm.pptURL = this.PptFilesId[0];
      console.log(this.ruleForm);
      blog.editBlog(this.blogId, this.ruleForm, tagStr).then((res) => {
        this.$alert("修改成功", "提示", {
